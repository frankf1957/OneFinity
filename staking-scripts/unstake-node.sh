...
# Array of BLS keys to be unstaked
...
do
    ...
    printf "calling do_unstake_nodes() with key: \n%s\n" "${short_key}"
    do_unstake_nodes "${KEY}"
    printf "return from do_unstake_nodes().\n"
done
